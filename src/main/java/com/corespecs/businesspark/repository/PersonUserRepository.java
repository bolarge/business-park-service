...
import com.corespecs.businesspark.model.BaseEntity;
...
public interface PersonUserRepository {
     ...
     * found)
     */
    Collection<PersonUser> findByLastName(String lastName) throws DataAccessException;
     ...
     */
    PersonUser findById(int id) throws DataAccessException;
     ...
     */
    void save(PersonUser owner) throws DataAccessException;
     ...
     * found)
     */
    Collection<PersonUser> findAll() throws DataAccessException;
     ...
     */
    //void delete(PersonUser owner) throws DataAccessException;
